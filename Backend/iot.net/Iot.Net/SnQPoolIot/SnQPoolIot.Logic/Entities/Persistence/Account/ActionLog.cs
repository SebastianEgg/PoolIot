...
{
    using System;
    partial class ActionLog : SnQPoolIot.Contracts.Persistence.Account.IActionLog
    {
        static ActionLog()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQPoolIot.Contracts.Persistence.Account.IActionLog instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQPoolIot.Contracts.Persistence.Account.IActionLog other)
        {
            if (other == null)
            {
                return false;
