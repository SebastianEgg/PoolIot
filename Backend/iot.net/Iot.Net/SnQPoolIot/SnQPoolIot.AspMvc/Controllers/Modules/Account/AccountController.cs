...
using SnQPoolIot.AspMvc.Models.Modules.Account;
using SnQPoolIot.AspMvc.Models.Persistence.Account;
using SnQPoolIot.AspMvc.Modules.Handler;
using AccountManager = SnQPoolIot.Adapters.Modules.Account.AccountManager;

namespace SnQPoolIot.AspMvc.Controllers
{
